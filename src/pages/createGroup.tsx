            ...
            <div className='content-center justify-center divide'>
                <div className='text-2xl font-semibold'>
                    ...
                    <form className='flex-col grid grid-cols-4 gap-4 w-[37.5vw]' action="">
                        ...
                        <div className='mb-2 rounded col-span-4'>
                            <label htmlFor="invite" className='block text-gray-700 text-sm font-bold mb-2 col-span-4'>Thêm thành viên (ID) (Không bắt buộc)</label>
                        ...
                        <button type='submit' className='bg-blue-600 hover:bg-blue-700 h-12 text-lg text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200 col-span-2'>Tạo nhóm</button>
                    </form>
                </div>
            </div>
        </div>
